<div>
    <x-dashboard-header title="نظرات من" subtitle="نظرهایی که برای مشاوره‌های انجام‌شده ثبت کرده‌اید."></x-dashboard-header>
    ...
    <div class="mt-6 space-y-3 pb-8">
        ...
        @empty
            <div class="rounded-2xl border border-dashed border-gray-300 bg-white p-14 text-center">
                <span class="material-symbols-rounded mx-auto block text-4xl text-gray-300">reviews</span>
