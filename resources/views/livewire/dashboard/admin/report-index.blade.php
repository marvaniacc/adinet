<div>
    <div class="flex flex-wrap items-center justify-between gap-3">
        <div>
            <x-dashboard-header title="گزارشات" subtitle="بایگانی خصوصی گزارش‌های توسعه و نگهداری آدینت."></x-dashboard-header>
    </div>
    ...
    <div class="mt-6 space-y-3 pb-8">
        ...
        @empty
            <div class="rounded-2xl border border-dashed border-gray-300 bg-white p-14 text-center">
                <span class="material-symbols-rounded mx-auto block text-4xl text-gray-300">folder_open</span>
